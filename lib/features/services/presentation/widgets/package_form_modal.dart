...
/// Modal para crear/editar paquetes de servicios
class PackageFormModal extends StatefulWidget {
  final Servicio? paquete;

  const PackageFormModal({super.key, this.paquete});

  @override
  State<PackageFormModal> createState() => _PackageFormModalState();
}

class _PackageFormModalState extends State<PackageFormModal> {
  ...
  void initState() {
    ...
    _nombreController = TextEditingController(
      text: widget.paquete?.nombre ?? '',
    );
    _descripcionController = TextEditingController(
      text: widget.paquete?.descripcion ?? '',
    );
    _precioController = TextEditingController(
      text: widget.paquete?.precio.toString() ?? '',
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isEditing = widget.paquete != null;
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: DesignTokens.purpleNeon.withValues(alpha: 0.1),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Contenido / Servicios',
                      hintText: 'Describe qué incluye',
                      prefixIcon: Icon(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: DesignTokens.space16),
                      FilledButton.icon(
                        onPressed: _isLoading ? null : _guardarPaquete,
                        icon: _isLoading
                            ? SizedBox(
                                width: 16,
                                height: 16,
